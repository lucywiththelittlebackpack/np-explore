            ...
            <div className="space-y-6">
                <div className="flex items-start gap-4 pb-6 border-b border-slate-100">
                    ...
                    <div>
                        ...
                        <div className="text-foreground font-bold text-lg">{trip.duration}</div>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4 pb-6 border-b border-slate-100">
                    ...
                    <div>
                        ...
                        <div className="text-foreground font-bold text-lg">{trip.vibe}</div>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4 pb-6 border-b border-slate-100">
                    ...
                    <div>
                        ...
                        <div className="text-foreground font-bold text-lg">{trip.parks.length} National Parks</div>
                    </div>
                </div>
            </div>
